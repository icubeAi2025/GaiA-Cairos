...
@Entity
@IdClass(DmAttachmentsId.class) // 복합 키 클래스 설정
@Data
@EqualsAndHashCode(callSuper = true)
@Alias("dmAttachments")
public class DmAttachments extends AbstractRudIdTime {
    ...
    @Id
    @Description(name = "파일 키", description = "", type = Description.TYPE.FIELD)
    String fileKey;
