...
public interface CwMainmtrlReqfrmRepository
        ...
        @Modifying
        @Query("UPDATE CwMainmtrlReqfrm cmr SET cmr.apReqId = NULL, cmr.apReqDt = NULL, cmr.apDocId = NULL, cmr.apprvlId = NULL, cmr.apprvlDt = NULL, cmr.apprvlStats = NULL, cmr.apOpnin = NULL, cmr.chgId = :chgId, cmr.chgDt = :chgDt WHERE cmr.apDocId = :apDocId")
