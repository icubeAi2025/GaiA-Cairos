...
@IdClass(PrWeeklyReportActivityId.class)
public class PrWeeklyReportActivity extends AbstractRudIdTime{
	...
	@Id
	@Description(name = "주간ActivityID", description = "", type = Description.TYPE.FIELD)
