...
public interface CwDailyReportResourceRepository extends JpaRepository<CwDailyReportResource, String>,
    ...
    @Modifying
    @Transactional
    @Query("UPDATE CwDailyReportResource cdrr SET actualQty = :actualQty, remndrQty = :remndrQty, dltYn = :dltYn WHERE cdrr.cntrctNo = :cntrctNo AND cdrr.dailyReportId = :dailyReportId AND cdrr.rsceSno = :rsceSno")
    void updateQtyByCntrctNoAndDailyReportIdAndRsceSnoAndDltYn(@Param("actualQty") BigDecimal actualQty,
