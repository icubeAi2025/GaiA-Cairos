...
public interface SmComCodeGroupRepository
    ...
    @Query(value = "SELECT MAX(c.cmnCdDsplyOrdr) FROM SmComCodeGroup c WHERE c.upCmnGrpCd = :upCmnGrpCd AND c.dltYn = 'N'")
    Short maxCdDsplyOrdrByUpCmnGrpCd(@Param("upCmnGrpCd")String upCmnGrpCd);
