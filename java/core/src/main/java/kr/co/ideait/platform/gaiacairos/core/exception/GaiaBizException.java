...
public class GaiaBizException extends BizException {

    ErrorType errorType;

    Throwable throwable;

    public GaiaBizException(ErrorType errorType) {
        super(errorType.getMessage());
        this.errorType = errorType;
    }

    public GaiaBizException(ErrorType errorType, Throwable throwable) {
        super(throwable == null ? "throwable is null" : throwable.getMessage(), throwable);
        this.errorType = errorType;
        this.throwable = throwable;
    }

    public GaiaBizException(ErrorType errorType, String message) {
        super(message);
        this.errorType = errorType;
    }

    public GaiaBizException(ErrorType errorType, String message, Throwable throwable) {
        super(message, throwable);
        this.errorType = errorType;
        this.throwable = throwable;
    }

    public GaiaBizException(ErrorType errorType, String message, String detailMessage) {
        super(message);
        this.errorType = errorType;
        this.detailMessage = detailMessage;
    }

    public GaiaBizException(ErrorType errorType, String message, String detailMessage, Throwable throwable) {
        super(message, throwable);
        this.errorType = errorType;
        this.detailMessage = detailMessage;
        this.throwable = throwable;
    ...
    public GaiaBizException(Exception exception) {
        super(ErrorType.getType(exception).getMessage());
        this.throwable = exception;
        this.errorType = ErrorType.getType(exception);
    }

    public static GaiaBizException of(Exception exception) {
...
//        errorCause.append("\nmessage: ").append(errorType.getMessage().equals(message) ? exception.getMessage() : message);
        ...
        return new GaiaBizException(errorType, message, errorCause.toString());
    }
