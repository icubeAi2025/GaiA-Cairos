package kr.co.ideait.platform.gaiacairos.core.persistence.vo.projectcost.contract;
...
//	ApDoc toApDoc(DraftDoc draftDoc);
//	
//	ApDoc toApDoc(TemporaryApDocSearch temporaryApDocSearch);
//	
...
//	List<ApLine> toApLineList(List<DraftApLine> apLineList);
     ...
     */
    @Data
    public class C3rMain extends CommonForm{
        File c3rFile;
        String cntrctNo;
        String cntrctChgId;
