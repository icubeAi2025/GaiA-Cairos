...
public class CommonCodeApiController extends AbstractController {
        ...
        public Result updateCommonCodeGroup(CommonReqVo commonReqVo, 
                        @RequestBody @Valid CommonCodeDto.SmComCodeGroup smComCodeGroup) {
                // 공통로그
                Log.SmUserLogDto userLog = commonReqVo.toSmUserLogDto();
                userLog.setLogType(LogType.FUNCTION.name());
        ...
        public Result groupUp(CommonReqVo commonReqVo, @RequestBody @Valid CommonCodeDto.SmComCodeGroup smComCodeGroup) {
                // 공통로그
                Log.SmUserLogDto userLog = commonReqVo.toSmUserLogDto();
                userLog.setLogType(LogType.FUNCTION.name());
        ...
        public Result groupDown(CommonReqVo commonReqVo, @RequestBody @Valid CommonCodeDto.SmComCodeGroup smComCodeGroup) {
                // 공통로그
                Log.SmUserLogDto userLog = commonReqVo.toSmUserLogDto();
                userLog.setLogType(LogType.FUNCTION.name());
        ...
        public Result createCommonCode(CommonReqVo commonReqVo, @RequestBody @Valid CommonCodeDto.SmComCode smComCode) {
                // 공통로그
                Log.SmUserLogDto userLog = commonReqVo.toSmUserLogDto();
                userLog.setLogType(LogType.FUNCTION.name());
        ...
        public Result updateCommonCode(CommonReqVo commonReqVo, @RequestBody @Valid CommonCodeDto.SmComCode smComCode) {
                // 공통로그
                Log.SmUserLogDto userLog = commonReqVo.toSmUserLogDto();
                userLog.setLogType(LogType.FUNCTION.name());
