...
public class MainmtrlReqfrmApiController extends AbstractController {
    ...
    public Result deleteMainmtrlReqfrm(CommonReqVo commonReqVo,
        ...
        mainmtrlReqfrmComponent.deleteMainmtrlReqfrm(input);
        return Result.ok();
    }
    ...
    public Result inspectionRequest(CommonReqVo commonReqVo,
        ...
        mainmtrlReqfrmComponent.inspectionRequestList(paramList, request, commonReqVo.getUserId(), commonReqVo.getUserName(), commonReqVo.getPjtNo());
        return Result.ok();
    }
    ...
    public Result paymentRequest(CommonReqVo commonReqVo,
        ...
        mainmtrlReqfrmComponent.paymentRequest(paramList, commonReqVo.getApiYn(), commonReqVo.getPjtDiv());
        return Result.ok();
    }
