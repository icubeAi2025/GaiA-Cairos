...
//        mybatisSession.selectOne("kr.co.ideait.platform.gaiacairos.mybatis.mappers.system.commoncode.selectSmComCodeGroupByCmnGrpNo");
    ...
    public SmComCodeGroup createCommonCodeGroup(SmComCodeGroup smComCodeGroup, String userId) {
        ...
        if(smComCodeGroup.getCmnGrpCd() == null || smComCodeGroup.getCmnGrpCd().isEmpty()){
    ...
    public CommonCodeDto.SmComCodeGroup updateCommonCodeGroup(CommonCodeDto.SmComCodeGroup smComCodeGroup, String userId) {
        ...
        return mybatisSession.selectOne("kr.co.ideait.platform.gaiacairos.mybatis.mappers.system.commoncode.selectSmComCodeGroupByCmnGrpCd", smComCodeGroup.getCmnGrpCd());
    }
...
//        smComCodeGroupRepository.findAllById(groupCodeNoList).forEach(smComCodeGroup -> {
        List<CommonCodeDto.SmComCodeGroup> list = mybatisSession.selectList("kr.co.ideait.platform.gaiacairos.mybatis.mappers.system.commoncode.selectListByCmnGrpCd", groupCodeNoList);
...
//                smComCodeGroupRepository.updateDelete(smComCodeGroup);
                ...
                //하위 코드들 삭제
                List<CommonCodeDto.SmComCode> smCmnCodeList = mybatisSession.selectList("kr.co.ideait.platform.gaiacairos.mybatis.mappers.system.commoncode.selectSmComCodeByCmnGrpCd",smComCodeGroup.getCmnGrpCd());
                for(CommonCodeDto.SmComCode smComCode : smCmnCodeList){
                ...
                if (smComCodeGroup.getCmnLevel() == 1) {
                    List<CommonCodeDto.SmComCodeGroup> subSmComCodeGroupList = mybatisSession.selectList("kr.co.ideait.platform.gaiacairos.mybatis.mappers.system.commoncode.selectSmComCodeGroupByUpCmnGrpCd",smComCodeGroup.getCmnGrpCd());
                    subSmComCodeGroupList
...
//                                smComCodeGroupRepository.updateDelete(subSmComCodeGroup);
                                ...
                                //하위 코드들 삭제
                                List<CommonCodeDto.SmComCode> subSmCmnCodeList = mybatisSession.selectList("kr.co.ideait.platform.gaiacairos.mybatis.mappers.system.commoncode.selectSmComCodeByCmnGrpCd",subSmComCodeGroup.getCmnGrpCd());
                                for(CommonCodeDto.SmComCode smComCode : subSmCmnCodeList){
                                    smComCode.setDltYn("Y");
                                    smComCode.setDltId(userId);
                                    mybatisSession.update("kr.co.ideait.platform.gaiacairos.mybatis.mappers.system.commoncode.updateCmnCode",smComCode);
                                }
    ...
    public SmComCode getCommonCodeByGrpCdAndCmnCd(String cmnGrpCd, String cmnCd) {
        ...
        return smComCodeRepository.findByCmnGrpCdAndCmnCd(cmnGrpCd,cmnCd);
    }
    ...
    public CommonCodeDto.SmComCode createCommonCode(CommonCodeDto.SmComCode smComCode, String userId) {
        if (smComCode.getCmnCdNo() == null || smComCode.getCmnCdNo().isEmpty()) {
            smComCode.setCmnCdNo(UUID.randomUUID().toString());
        }
        smComCode.setRgstrId(userId);
        smComCode.setChgId(userId);

        if(mybatisSession.insert("kr.co.ideait.platform.gaiacairos.mybatis.mappers.system.commoncode.insertCmnCode",smComCode) > 0){
            return mybatisSession.selectOne("kr.co.ideait.platform.gaiacairos.mybatis.mappers.system.commoncode.selectSmComCodeByCmnCdNo",smComCode.getCmnCdNo());
        }
        return null;
    }
    ...
    public CommonCodeDto.SmComCode updateCommonCode(CommonCodeDto.SmComCode smComCode, String userId) {
        ...
        int result = mybatisSession.update("kr.co.ideait.platform.gaiacairos.mybatis.mappers.system.commoncode.updateCmnCode", smComCode);
        if(result == 1) {
            return mybatisSession.selectOne("kr.co.ideait.platform.gaiacairos.mybatis.mappers.system.commoncode.selectSmComCodeByCmnCdNo", smComCode.getCmnCdNo());
        }
        else{
