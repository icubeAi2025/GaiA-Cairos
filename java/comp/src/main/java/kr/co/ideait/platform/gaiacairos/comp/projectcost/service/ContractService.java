...
public class ContractService extends AbstractGaiaCairosService {
    ...
    public List<Map<String, ?>> selectCostCalculatorList(String chgId, String cntrctId) {
        ...
        try {
            result = mybatisSession.selectList("kr.co.ideait.platform.gaiacairos.core.persistence.mybatis.projectcost.contract.selectCostCalculatorList", contractFormTypeSelectInput);
