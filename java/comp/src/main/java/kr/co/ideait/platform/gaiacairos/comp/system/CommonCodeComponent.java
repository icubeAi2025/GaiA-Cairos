...
public class CommonCodeComponent extends AbstractComponent {
	...
	public List<CommonCodeMybatisParam.CommonCodeGroupListOutput> getCommonCodeGroupList() {
	...
	public SmComCodeGroup createCommonCodeGroup(SmComCodeGroup smComCodeGroup, CommonReqVo commonReqVo) {
		SmComCodeGroup returnData = commonCodeService.createCommonCodeGroup(smComCodeGroup);
	...
	@Transactional
	public SmComCodeGroup updateCommonCodeGroup(SmComCodeGroup smComCodeGroup, CommonReqVo commonReqVo) {
		SmComCodeGroup returnData = commonCodeService.updateCommonCodeGroup(smComCodeGroup);
	...
	public Map deleteCommonCodeGroup(List<String> groupCodeCdList, CommonReqVo commonReqVo) {
		...
		commonCodeService.deleteCommonCodeGroup(groupCodeCdList);
	...
	@Transactional
	public boolean upGroup(SmComCodeGroup smComCodeGroup, CommonReqVo commonReqVo) {
		boolean result = commonCodeService.upGroup(smComCodeGroup);
	...
	@Transactional
	public boolean downGroup(SmComCodeGroup smComCodeGroup, CommonReqVo commonReqVo) {
		commonCodeService.downGroup(smComCodeGroup);
	...
	public Page<CommonCodeMybatisParam.CommonCodeListOutput> getCommonCodeListGrid(CommonCodeMybatisParam.CommonCodeListInput commonCodeListInput) {
	...
	public CommonCodeMybatisParam.CodeOutput getCommonCodeLoadData(String cmnCdNo) {
	...
	@Transactional
	public SmComCode createCommonCode(SmComCode smComCode, CommonReqVo commonReqVo) {
		SmComCode returnData = commonCodeService.createCommonCode(smComCode);
	...
	@Transactional
	public SmComCode updateCommonCode(SmComCode smComCode, CommonReqVo commonReqVo) {
		SmComCode returnData = commonCodeService.updateCommonCode(smComCode);
	...
	public void updateCommonCodeOrder(List<SmComCode> codeList, CommonReqVo commonReqVo) {
		commonCodeService.updateCommonCodeOrder(codeList);
	...
	public void deleteCommonCode(List<SmComCode> codeList, CommonReqVo commonReqVo) {
		commonCodeService.deleteCommonCode(codeList);
	...
	public Map receiveInterfaceService(String transactionId, Map params) {
		...
		try {
			...
			//
				...
				SmComCode smComCode = objectMapper.convertValue(params.get("smComCode"), SmComCode.class);
				String userId = MapUtils.getString(params, "userId");
