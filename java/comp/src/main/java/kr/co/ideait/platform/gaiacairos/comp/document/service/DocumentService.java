...
//            mybatisSession.insert("kr.co.ideait.platform.gaiacairos.mybatis.mappers.document.document.insertAutoMyAuthority", authInput);
    ...
    public Map<String, Object> createApprovalDocument(Map<String, Object> requestParams) {
        ...
        Map<String, Object> result = new HashMap<>(); // 결과 데이터 map
        ...
        if(savedApDoc == null){
            log.error("[createApprovalDocument] 결재 문서 생성에 실패하였습니다.(savedApDoc)");
            result.put("resultCode", "01");
            result.put("resultMsg", "결재 문서 생성에 실패하였습니다.");
        ...
        String draftDt = (String)apDoc.get("apAppDt");
        String apprerId = (String)requestParams.get("apCmpltUsrNms");
        String apprerDt = (String)apDoc.get("apCmpltDt");
